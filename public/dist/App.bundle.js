...
function typeAhead(search) {
	...
	searchInput.on('input', function () {
		...
		// shortcut for addEventListener using Bling.js 
	...
	searchInput.on('keyup', function (e) {
		// If not pressing up, down, or enter skip
...
function setLocation(pos) {
	...
	var map = new google.maps.Map((0, _bling.$)('#map'), mapOptions);
	loadPlaces(map);
};
...
function makeMap(mapDiv) {
	if (!mapDiv) return;
	navigator.geolocation.getCurrentPosition(setLocation, geoLocateError);
	// Make map time!
